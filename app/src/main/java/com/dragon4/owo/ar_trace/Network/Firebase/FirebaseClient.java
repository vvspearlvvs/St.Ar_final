...
/*
    ...
    @Override
    public ArrayList<MyPageVisitedlistItem> getMyPageVlistFromServer(String userID) {
        return null;
    }

    public ArrayList<AD> getAdToServer(String buildingID, AdRecyclerViewAdapter adAdapter){
        return  null;
    }

    public ArrayList<MyPageSearchlistItem> getMyPageSlistFromServer(String userID){
        return null;
    }

    public ArrayList<MyPageReviewlistItem> getMyPageRlistFromServer(String userID){
        return null;
    }
    */
}